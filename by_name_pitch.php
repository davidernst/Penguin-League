...
$result = mysql_query ("SELECT id, team, full_name, pos FROM dick_league_pitchers WHERE full_name LIKE '%".$searchtext."%' ORDER BY team");
...
echo "<INPUT TYPE='hidden' NAME='position' VALUE='P'>";
?>
